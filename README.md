...
2. Install NPM packages
   ...
   IMPORTANT NOTE(MACOS): If you are using macos you need to install "xz" `brew install xz`
   IMPORTANT NOTE(LINUX): If you are using linux you need to install "libgl1-mesa-glx" `apt install libgl1-mesa-glx`
