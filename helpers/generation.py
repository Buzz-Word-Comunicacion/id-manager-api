...
from models.validations import ImageResponse
...
def generacion_imagenes(tema: str) -> ImageResponse:
    pipe = configurar_modelo_stable_diffusion()

    while True:
        # tema_usuario = input("Elige un tema para tu TDC: ") # Se quitó para que entre como variable
        ...
        while contador < max_imagenes:
            ...
            imagen_base64[f'imagen{i}'] = combinar_imagenes_base64(boceto_path, imagen_generada)
